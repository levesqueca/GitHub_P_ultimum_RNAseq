...
stargazer(cazyFamGene, type = "html",
          ...
          out = "tab-PyuuGenes_AllCazy_stargazer.htm",
          summary = FALSE,
          header = TRUE,
          flip = FALSE)
...
png(file = paste("/home/AAFC-AAC/girouxem/GitHub_P_ultimum_RNAseq/data/ggplotOfAllSppCAZyFamUp.png", sep = ""))
