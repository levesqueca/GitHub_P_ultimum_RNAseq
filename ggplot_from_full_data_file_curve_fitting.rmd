...
sub_my_counts_NL <-  my_counts_NL[ , c("Condition", "TimePoint", "RNA_Replicate", "PYU1_T005252", "PYU1_T005352")]

colnames(my_counts_NL)

sub_my_counts_NL$log_time <- log(sub_my_counts_NL$TimePoint+1)
...
library("nlsMicrobio")
library(nlstools)
sub_my_counts_NL$log_PYU1_T005252 <- log10(sub_my_counts_NL$PYU1_T005252 +1)

   NL_fit <- nls(log_PYU1_T005252 ~   max*exp(-((log_time - cent)^2) / (2 * StDev^2)), 
