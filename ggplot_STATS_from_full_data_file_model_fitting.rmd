...
subset_count2 <- subset_count2[subset_count3$SequenceID %in% listLoci_notduplicated$SequenceID,]
...
my_counts_NL$log_PYU1_T011896 <- log(my_counts_NL$PYU1_T011896 +1)
   ...
   NL_fit <- nls(PYU1_T011896 ~   exp(max*exp(-((sqrt_time - cent)^2) / (2 * StDev^2))), 
              start=list(max = 1, cent = 2, StDev =1), data=my_counts_NL, trace=TRUE)
