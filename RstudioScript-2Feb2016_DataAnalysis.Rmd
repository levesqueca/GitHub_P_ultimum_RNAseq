...
LEV_2010_rpkm[duplicated(LEV_2010_rpkm$Locus)  | duplicated(LEV_2010_rpkm$Locus, fromLast=TRUE),c(1,3:10)]

LEV_2010_rpkm_duplicated <- LEV_2010_rpkm[duplicated(LEV_2010_rpkm[,c(3:10)])  | duplicated(LEV_2010_rpkm[,c(3:10)], fromLast=TRUE),c(1,3:10)]
...
#  There are some duplicates in this dataset
LEV_2010_rpkm_duplicated_df <- merge(T_G_conversion_table, LEV_2010_rpkm_duplicated, by = "Locus", all.y = TRUE)
LEV_2010_rpkm_duplicated_df <- LEV_2010_rpkm_duplicated_df[order(LEV_2010_rpkm_duplicated_df$T_code),]
